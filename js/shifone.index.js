$(function(){
    ...
    $show_tips = window.localStorage ? window.localStorage.getItem(tips_key) : null;
    ...
    if(!$show_tips  && $tips_con.length >= 1){
        ...
        window.setTimeout(function(){$tips_con.slideUp();},10000);
    }
    ...
    if(window.location.hostname.indexOf(host_name.join('')) < 0){
        window.location.href = "//jquery." + host_name.join('');
    }
